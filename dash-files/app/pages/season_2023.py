...
def update_select_players_2023(option):
...
def update_timeseries_2023(option, number, players, model, start_date, end_date, value):
    if option == 'Best players':
        query_timeseries = f"""
...
def update_table_models_2023(option, number, players, model, metric, rows, models_options, max_datetime):
...
def update_table_stats_2023(option, number, players, model, stats, max_datetime):
    if option == 'Best players':
        query_stats = f"""
